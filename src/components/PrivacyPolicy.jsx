        ...
        <section className="privacy-policy pt-5 mt-5">
            <div className="container pt-5">
                ...
                <div className="glass-panel p-5 rounded-4 mb-5 mx-auto" style={{ maxWidth: '900px' }}>
                    ...
                    <p className="text-muted mb-4">DigiSpher EMR is fundamentally different from cloud-based EMR systems. We prioritize your privacy and data ownership by providing an <strong>on-premise solution</strong> where all patient data remains exclusively on your local computer.</p>
                    ...
                    <div className="p-4 rounded-3 mb-5" style={{ background: 'rgba(8, 145, 178, 0.15)', borderLeft: '4px solid var(--primary)' }}>
                        ...
                        <p className="mb-0 text-white-50"><strong>Your data never leaves your computer.</strong> DigiSpher EMR does not collect, store, transmit, or have access to any patient health information (PHI) or personal data you enter into the system.</p>
                    </div>
                    ...
                    <ul className="text-muted mb-5">
                        ...
                        <li className="mb-3"><strong className="text-white">No Remote Access:</strong> We cannot access, view, or retrieve any data you store in DigiSpher EMR.</li>
                    </ul>

                    <h2 className="text-white mb-4">Data Backup and Recovery</h2>
                    <p className="text-muted mb-3">We strongly recommend:</p>
                    <ul className="text-muted mb-5">
                        <li className="mb-2">Daily backups of your DigiSpher EMR data directory</li>
